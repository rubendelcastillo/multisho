...
describe('Service Tests', () => {
  describe('ModoPagoMySuffix Service', () => {
    let injector: TestBed;
    let service: ModoPagoMySuffixService;
    let httpMock: HttpTestingController;
    let elemDefault: IModoPagoMySuffix;
    let expectedResult: IModoPagoMySuffix | IModoPagoMySuffix[] | boolean | null;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ModoPagoMySuffix', () => {
      ...
      it('should delete a ModoPagoMySuffix', () => {
