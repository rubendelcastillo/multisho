...
describe('Service Tests', () => {
  describe('RegionMySuffix Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new RegionMySuffix(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a RegionMySuffix', async () => {
        ...
        service
          .create(new RegionMySuffix(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a RegionMySuffix', async () => {
        const returnedFromService = Object.assign(
          {
            regionName: 'BBBBBB'
          },
      ...
      it('should return a list of RegionMySuffix', async () => {
        const returnedFromService = Object.assign(
          {
            regionName: 'BBBBBB'
          },
      ...
      it('should delete a RegionMySuffix', async () => {
