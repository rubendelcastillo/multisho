...
import com.vankas.multishop.domain.Product;
import com.vankas.multishop.repository.ProductRepository;
import com.vankas.multishop.service.ProductService;
import com.vankas.multishop.service.dto.ProductDTO;
import com.vankas.multishop.service.mapper.ProductMapper;
...
public class ProductResourceIT {
    ...
    private static final Double DEFAULT_PRECIO_CON_IVA = 1D;
    private static final Double UPDATED_PRECIO_CON_IVA = 2D;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .stock(DEFAULT_STOCK)
            .precioConIva(DEFAULT_PRECIO_CON_IVA);
        return product;
    }
    /**
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .stock(UPDATED_STOCK)
            .precioConIva(UPDATED_PRECIO_CON_IVA);
        return product;
    }
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPrecioConIva()).isEqualTo(DEFAULT_PRECIO_CON_IVA);
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getPrecioConIva()).isEqualTo(UPDATED_PRECIO_CON_IVA);
    }
