...
public class ClientResourceIT {
    ...
    private static final DocumentType UPDATED_DOCUMENT_TYPE = DocumentType.IDENTITY_CARD;
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getDocumentId()).isEqualTo(DEFAULT_DOCUMENT_ID);
        assertThat(testClient.getDocumentType()).isEqualTo(DEFAULT_DOCUMENT_TYPE);
    }
    ...
    public void updateClient() throws Exception {
        ...
        assertThat(testClient.getDocumentId()).isEqualTo(UPDATED_DOCUMENT_ID);
        assertThat(testClient.getDocumentType()).isEqualTo(UPDATED_DOCUMENT_TYPE);
    }
