...
import com.vankas.multishop.domain.Location;
import com.vankas.multishop.repository.LocationRepository;
import com.vankas.multishop.service.LocationService;
import com.vankas.multishop.service.dto.LocationDTO;
import com.vankas.multishop.service.mapper.LocationMapper;
...
public class LocationResourceIT {
    ...
    private static final String DEFAULT_COMPLEMENTARY_INFO = "AAAAAAAAAA";
    private static final String UPDATED_COMPLEMENTARY_INFO = "BBBBBBBBBB";

    private static final String DEFAULT_NUMBER = "AAAAAAAAAA";
    private static final String UPDATED_NUMBER = "BBBBBBBBBB";

    private static final String DEFAULT_MAIN_DOOR = "AAAAAAAAAA";
    private static final String UPDATED_MAIN_DOOR = "BBBBBBBBBB";

    private static final String DEFAULT_FLAT_DOOR = "AAAAAAAAAA";
    private static final String UPDATED_FLAT_DOOR = "BBBBBBBBBB";
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location()
            ...
            .complementaryInfo(DEFAULT_COMPLEMENTARY_INFO)
            .number(DEFAULT_NUMBER)
            .mainDoor(DEFAULT_MAIN_DOOR)
            .flatDoor(DEFAULT_FLAT_DOOR)
            .level(DEFAULT_LEVEL)
            .stair(DEFAULT_STAIR)
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location()
            ...
            .complementaryInfo(UPDATED_COMPLEMENTARY_INFO)
            .number(UPDATED_NUMBER)
            .mainDoor(UPDATED_MAIN_DOOR)
            .flatDoor(UPDATED_FLAT_DOOR)
            .level(UPDATED_LEVEL)
            .stair(UPDATED_STAIR)
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getComplementaryInfo()).isEqualTo(DEFAULT_COMPLEMENTARY_INFO);
        assertThat(testLocation.getNumber()).isEqualTo(DEFAULT_NUMBER);
        assertThat(testLocation.getMainDoor()).isEqualTo(DEFAULT_MAIN_DOOR);
        assertThat(testLocation.getFlatDoor()).isEqualTo(DEFAULT_FLAT_DOOR);
        assertThat(testLocation.getLevel()).isEqualTo(DEFAULT_LEVEL);
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getComplementaryInfo()).isEqualTo(UPDATED_COMPLEMENTARY_INFO);
        assertThat(testLocation.getNumber()).isEqualTo(UPDATED_NUMBER);
        assertThat(testLocation.getMainDoor()).isEqualTo(UPDATED_MAIN_DOOR);
        assertThat(testLocation.getFlatDoor()).isEqualTo(UPDATED_FLAT_DOOR);
        assertThat(testLocation.getLevel()).isEqualTo(UPDATED_LEVEL);
